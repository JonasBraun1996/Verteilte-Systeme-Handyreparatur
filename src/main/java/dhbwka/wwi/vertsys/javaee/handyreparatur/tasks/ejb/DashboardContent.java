 ...
 */
package dhbwka.wwi.vertsys.javaee.handyreparatur.tasks.ejb;

import dhbwka.wwi.vertsys.javaee.handyreparatur.common.web.WebUtils;
import dhbwka.wwi.vertsys.javaee.handyreparatur.dashboard.ejb.DashboardContentProvider;
import dhbwka.wwi.vertsys.javaee.handyreparatur.dashboard.ejb.DashboardSection;
import dhbwka.wwi.vertsys.javaee.handyreparatur.dashboard.ejb.DashboardTile;
import dhbwka.wwi.vertsys.javaee.handyreparatur.tasks.jpa.Category;
import dhbwka.wwi.vertsys.javaee.handyreparatur.tasks.jpa.TaskStatus;
...
public class DashboardContent implements DashboardContentProvider {
    ...
    private DashboardSection createSection(Category category) {
        ...
        DashboardTile tile = this.createTile(category, null, "Alle", cssClass + " status-all", "th");
