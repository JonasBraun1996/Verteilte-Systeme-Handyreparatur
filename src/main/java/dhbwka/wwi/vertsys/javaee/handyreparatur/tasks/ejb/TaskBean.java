...
import dhbwka.wwi.vertsys.javaee.handyreparatur.common.ejb.EntityBean;
...
import dhbwka.wwi.vertsys.javaee.handyreparatur.common.jpa.User;
...
public class TaskBean extends EntityBean<Task, Long> { 
    ...
    public List<Task> findByUsername(String username) {
     ...
     public List<Task> findAllByUser(User owner) {
        return this.em.createQuery("SELECT p FROM Task p wHERE p.owner = :owner")
