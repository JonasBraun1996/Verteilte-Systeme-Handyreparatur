...
<template:base>
    ...
    <jsp:attribute name="menu">
        ...
        <div class="menuitem">
            <a href="<c:url value="/app/tasks/task/new/"/>">Neuer Auftrag anlegen</a>
        </div>
    ...
    <jsp:attribute name="content">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <jsp:useBean id="utils" class="dhbwka.wwi.vertsys.javaee.handyreparatur.common.web.WebUtils"/>
                ...
                <table>
                    ...
                    <c:forEach items="${tasks}" var="task">
                        <tr>
                            <td>
                                <a class="icon-pencil" href="<c:url value="/app/tasks/task/${task.id}/"/>">
